...
embeddings=OpenAIEmbeddings(api_key="sk-v2nYTd4xY-1KlX4HYiExEN0zm2AMg4EFeCKNmUUsSjT3BlbkFJdcWz5PgWtKvBOQQJRl_i6_V5EYQr8Hl_YVWgbzO9UA")
index_name="chatbot"
...
llm = ChatOpenAI(
    api_key="sk-v2nYTd4xY-1KlX4HYiExEN0zm2AMg4EFeCKNmUUsSjT3BlbkFJdcWz5PgWtKvBOQQJRl_i6_V5EYQr8Hl_YVWgbzO9UA",
    model="gpt-4",
    temperature=0,
